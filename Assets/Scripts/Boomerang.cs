...
namespace Hykudoru
{
    ...
    public class Boomerang : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            ScytheEndPoint = GameObject.Find("ScytheEndPoint");
            displacement = ScytheEndPoint.transform.position;
        }
        ...
        {
            Oscillate();
            if (Vector3.Distance(initialPosition, transform.position) <= 1.0f) Destroy(gameObject);
        }
